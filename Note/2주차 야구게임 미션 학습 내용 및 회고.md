...
이를 우테코 프리코스 미션에 적용을 해보고 싶어 직접 적용을 했었습니다.
...
하지만 지원 홈페이지에서 테스트 할 때 예기치 못한 실행 오류가 계속 발생하여 계층형 코드를 전부 제거했고.. 

추후에 개인 프로젝트 때 적용해보기로 했습니다. 

결과에는 영향이 없겠지만 그래도 파란 불을 보고싶었습니다..
