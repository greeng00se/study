...
해당 클래스 파일에서 사용하는 모든 속성 값들의 모음이다.  
정해진 클래스 파일의 구조를 확장하는 역할을 한다.  
클래스의 동작 및 컴파일러에서 사용되는 정보를 포함한다. 예) 예외, 지역변수, 파일명 등등
...
[Class 파일 형식, Oracle](https://docs.oracle.com/javase/specs/jvms/se11/html/jvms-4.html)